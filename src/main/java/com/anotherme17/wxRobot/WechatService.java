package com.anotherme17.wxRobot;

import com.anotherme17.wxRobot.api.WechatApi;
import com.anotherme17.wxRobot.handle.MessageHandle;
 ...
 */
public class WechatService extends WechatApi {
        ...
        if (groupList.size() > 0) {
            executorService.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    WechatService.super.fetchGroupContacts();
                }
            });
        }
