package com.anotherme17.wxRobot.api;

import com.anotherme17.wxRobot.Utils;
import com.anotherme17.wxRobot.model.Const;
import com.anotherme17.wxRobot.model.Session;
...
public class WechatApi {
    ...
    public String genqrcode() {
        ...
        final File output = new File("E://qrcode.jpg");
    ...
    private JsonElement doPost(String url, Object object) {
        ...
        if (null != object) {
            ...
            requestBody = okhttp3.RequestBody.create(JSON, bodyJson);
        }
